// storium_data.js
// Data Model and CRUD for Storium Interactive
...
export function buildDataModelFromTables(tables) {
...
export function getGames() { return state.games; }
export function getSelectedGameIdx() { return state.selectedGameIdx; }
export function setSelectedGameIdx(idx) { state.selectedGameIdx = idx; }
export function getPlayers() { return state.players; }
export function getGameSettings() { return state.gameSettings; }
export function getCharacters() { return state.characters; }
